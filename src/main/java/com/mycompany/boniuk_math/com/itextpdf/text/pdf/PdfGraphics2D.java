...
import com.mycompany.boniuk_math.om.itextpdf.text.Image;
import com.mycompany.boniuk_math.com.itextpdf.text.pdf.internal.PolylineShape;
...
public class PdfGraphics2D extends Graphics2D {
  ...
  public boolean drawImage(Image img, AffineTransform xform, ImageObserver obs) {
    return drawImage(img, (Image)null, xform, (Color)null, obs);
  }
  ...
  private void setPaint(boolean invert, double xoffset, double yoffset, boolean fill) {
    if (this.paint instanceof Color) {
      ...
      PdfShading shading = PdfShading.simpleAxial(this.cb.getPdfWriter(), (float)p1.getX(), normalizeY((float)p1.getY()), (float)p2.getX(), normalizeY((float)p2.getY()), new BaseColor(c1), new BaseColor(c2));
...
/* Location:              C:\Users\windo\Desktop\itextpdf-5.1.1.jar!\com\itextpdf\text\pdf\PdfGraphics2D.class
