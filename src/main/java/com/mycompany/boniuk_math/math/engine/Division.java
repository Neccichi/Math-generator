...
import java.text.SimpleDateFormat;
     ...
     */
	    ...
	    //---------------------------------
	        ...
	        String fileName = "Division Worksheet__" + currentTime() + "p" + addme + ".pdf";
	    ...
	    //----------------------------------------
           ...
           //generate arrays (not function since can't return two arrays[])
	        ...
	        {
	            int number = (int) (Math.random() * 70 + 11);
	        ...
	        */
	        ...
	        while ((array[i] % array2[i] !=0))
	        {
	        	array[i] = (int) (Math.random() * 70 + 11);
	        	array2[i] = (int) (Math.random() * 8 + 2);
	        }
	        ...
	        */
	        ...
	        final int HEADER_FONT_SIZE = 28;
	      		Paragraph header = new Paragraph("      Two-Digit by One-Digit Division", new Font(FontFamily.HELVETICA, HEADER_FONT_SIZE, Font.BOLD, new BaseColor(0, 0, 0)) );
	            document.add(header);
