...
public class PdfDate extends PdfString {
  private static final int[] DATE_SPACE = new int[] { 
  ...
  public static Calendar decode(String s) {
    try {
      ...
      calendar.clear();
      idx = 0;
      for (int k = 0; k < DATE_SPACE.length && 
        idx < slen; k += 3) {
...
/* Location:              C:\Users\windo\Desktop\itextpdf-5.1.1.jar!\com\itextpdf\text\pdf\PdfDate.class
