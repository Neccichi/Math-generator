...
import com.mycompany.boniuk_math.com.itextpdf.text.pdf.collection.PdfTargetDictionary;
...
public class PdfAction extends PdfDictionary {
  ...
  public static PdfAction gotoEmbedded(String filename, PdfTargetDictionary target, PdfObject dest, boolean newWindow) {
    ...
    action.put(PdfName.T, (PdfObject)target);
    action.put(PdfName.D, dest);
      ...
      if (o != null)
        if (o instanceof PdfIndirectReference) {
          ...
          if (s.equalsIgnoreCase("on")) {
            ...
            throw new IllegalArgumentException(MessageLocalization.getComposedMessage("a.string.1.was.passed.in.state.only.on.off.and.toggle.are.allowed", new Object[] { s }));
          } 
          a.add(name);
        } else {
          throw new IllegalArgumentException(MessageLocalization.getComposedMessage("invalid.type.was.passed.in.state.1", new Object[] { o.getClass().getName() }));
        }  
    } 
...
/* Location:              C:\Users\windo\Desktop\itextpdf-5.1.1.jar!\com\itextpdf\text\pdf\PdfAction.class
