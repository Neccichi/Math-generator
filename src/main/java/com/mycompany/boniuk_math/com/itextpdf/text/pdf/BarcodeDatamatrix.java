...
public class BarcodeDatamatrix {
  ...
  private static final DmParams[] dmSizes = new DmParams[] { 
  ...
  private void setBit(int x, int y, int xByte) {
    this.image[y * xByte + x / 8] = (byte)(this.image[y * xByte + x / 8] | (byte)(128 >> (x & 0x7)));
  }
  ...
  public int generate(byte[] text, int textOffset, int textSize) {
    ...
    if (this.height == 0 || this.width == 0) {
      ...
      e += extCount;
      int k;
      for (k = 0; k < dmSizes.length && 
        (dmSizes[k]).dataSize < e; k++);
      dm = dmSizes[k];
      ...
      int k;
      for (k = 0; k < dmSizes.length && (
        this.height != (dmSizes[k]).height || this.width != (dmSizes[k]).width); k++);
      if (k == dmSizes.length)
        return 3; 
      dm = dmSizes[k];
  ...
  static class Placement {
    ...
    private static final Hashtable<Integer, short[]> cache = (Hashtable)new Hashtable<Integer, short>();
  ...
  static class ReedSolomon {
    private static final int[] log = new int[] { 
    ...
    private static final int[] alog = new int[] { 
    ...
    private static final int[] poly48 = new int[] { 
    ...
    private static final int[] poly56 = new int[] { 
    ...
    private static final int[] poly62 = new int[] { 
    ...
    private static final int[] poly68 = new int[] { 
...
/* Location:              C:\Users\windo\Desktop\itextpdf-5.1.1.jar!\com\itextpdf\text\pdf\BarcodeDatamatrix.class
