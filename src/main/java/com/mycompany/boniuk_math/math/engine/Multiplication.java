...
import java.text.SimpleDateFormat;
	...
	/** Generates pdf with 56 1-digit multiplication problems
	 * @author VaniaSpeedy
	 * */
	public class Multiplication {
		final static int ARRAY_LENGTH = 70;//number of problems (number pairs)
     ...
     */
	    ...
	    //---------------------------------
	        ...
	        String fileName = "Multiplication Worksheet__" + currentTime() + "p" + addme + ".pdf";
	    ...
	    //----------------------------------------
           ...
           //generate arrays (not function since can't return two arrays[])
	        ...
	        final int HEADER_FONT_SIZE = 26;
	      		Paragraph header = new Paragraph("   One Digit Multiplication Practice", new Font(FontFamily.HELVETICA, HEADER_FONT_SIZE, Font.BOLD, new BaseColor(0, 0, 0)) );
	            document.add(header);
	      	...
	      	//main loop - prints 7 rows
	            ...
	            final int NUMBER_OF_PROBLEMS = 10;
                for (int h=0; h < NUMBER_OF_ROWS; h++)
	      		{
	      			final int FONT_SIZE = 20;
	      			//create top half of addition problems
	      			String topRow = "   " + array[h+counterTop] + "   " + array[h+1+counterTop] + "   " + array[h+2+counterTop] + "   " + array[h+3+counterTop] + "   " + array[h+4+counterTop] + "   " + array[h+5+counterTop] + "   " + array[h+6+counterTop] + "   " + array[h+7+counterTop] + "   " + array[h+8+counterTop] + "   " + array[h+9+counterTop];
	                ...
	                document.add(spacer);
	      			...
	      			{
	      				String problem = "x" + array2[i+counterBottom];
	      			...
	      			counterTop += NUMBER_OF_PROBLEMS-1;
	      			counterBottom +=NUMBER_OF_PROBLEMS;
