...
public class PdfShading {
  ...
  public static PdfShading simpleAxial(PdfWriter writer, float x0, float y0, float x1, float y1, BaseColor startColor, BaseColor endColor, boolean extendStart, boolean extendEnd) {
    ...
    PdfFunction function = PdfFunction.type2(writer, new float[] { 0.0F, 1.0F }, null, getColorArray(startColor), getColorArray(endColor), 1.0F);
...
/* Location:              C:\Users\windo\Desktop\itextpdf-5.1.1.jar!\com\itextpdf\text\pdf\PdfShading.class
