...
public class Base64 {
  ...
  public static byte[] decode(String s, int options) {
    try {
      arrayOfByte = s.getBytes("UTF-8");
    } catch (UnsupportedEncodingException uee) {
      arrayOfByte = s.getBytes();
    } 
    byte[] arrayOfByte = decode(arrayOfByte, 0, arrayOfByte.length, options);
...
/* Location:              C:\Users\windo\Desktop\itextpdf-5.1.1.jar!\com\itextpdf\text\pdf\codec\Base64.class
